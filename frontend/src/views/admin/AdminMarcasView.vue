      ...
      <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-gray-100">
          <tr v-for="m in marcasPagina" :key="m.id" class="hover:bg-gray-50/60">
            <td class="p-3">
              <img v-if="m.imagen" :src="uploadUrl('marcas', m.imagen)" class="w-9 h-9 object-contain rounded" />
              <div v-else class="w-9 h-9 rounded bg-primary-50 text-primary-400 flex items-center justify-center text-xs">
